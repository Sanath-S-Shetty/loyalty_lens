...
export default function ProgramsView({ brand }) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white/[0.03] backdrop-blur-md border border-white/[0.06] rounded-3xl p-6 md:p-8 shadow-2xl relative overflow-hidden">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-3 gap-4 pt-6">
          ...
          <div className="bg-white/[0.02] border border-white/5 rounded-2xl p-4">
            ...
            <div className="text-2xl font-bold text-white mt-1">{brand.sentiment.positive}%</div>
          </div>
     ...
     {/* Strengths and Weaknesses Grid Card */}
<div className="bg-white/[0.03] backdrop-blur-md border border-white/[0.06] rounded-3xl p-6 md:p-8 shadow-2xl">
  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
    {/* Strengths Column */}
    <div>
      <h4 className="text-xs font-semibold text-emerald-400 mb-3 uppercase tracking-wider">Strengths</h4>
      <div className="bg-white/[0.02] border border-white/5 rounded-xl p-4 hover:bg-white/[0.04] transition-all duration-200">
        {brand.strengths ? (
          ...
          <p className="text-sm text-gray-500 italic">No strengths data available.</p>
        )}
      </div>
    </div>
    ...
    {/* Weaknesses Column */}
    <div>
      <h4 className="text-xs font-semibold text-rose-400 mb-3 uppercase tracking-wider">Weaknesses</h4>
      <div className="bg-white/[0.02] border border-white/5 rounded-xl p-4 hover:bg-white/[0.04] transition-all duration-200">
        {brand.weaknesses ? (
          <p className="text-sm text-gray-300 leading-relaxed">
            {brand.weaknesses}
          ...
          <p className="text-sm text-gray-500 italic">No weaknesses data available.</p>
        )}
      </div>
    </div>
  </div>
